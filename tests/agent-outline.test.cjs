...
test("workspace runtime replay requests a fresh snapshot after queue overflow", () => {
    ...
    assert.deepEqual(recoverWorkspaceCapabilityRuntime(queue, 0, snapshot), {ok: true, mode: "snapshot", cursor: 2, events: [], snapshot});
