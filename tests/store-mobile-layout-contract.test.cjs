...
test('new config form receives created instance', () => assert.match(source, /openHomeConfigForm\.call\(this, createdInstance, def\.configSchema/));
test('new config save rerenders store', () => assert.match(source, /openHomeConfigForm\.call\(this, createdInstance, def\.configSchema, \(\) => \{\s*renderStore\(\)/));
...
test('configure action uses added instance', () => assert.match(source, /openHomeConfigForm\.call\(this, addedInstance, def\.configSchema/));
test('configure action rerenders after save', () => assert.match(source, /openHomeConfigForm\.call\(this, addedInstance, def\.configSchema, \(\) => \{\s*renderStore\(\)/));
