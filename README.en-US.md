...
[![Version](https://img.shields.io/badge/version-0.25.0-blue)](./plugin.json) [![License: MIT](https://img.shields.io/badge/license-MIT-green)](./LICENSE) [![SiYuan](https://img.shields.io/badge/SiYuan-SiYuan_Note-ff5c67)](https://b3log.org/siyuan)
...
The current version is `v0.25.0` (officially published on 2026-09-20; Release assets are built automatically by the workflow).
