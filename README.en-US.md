...
**Test matrix**: `pnpm test` discovers all 206 `*.test.cjs` files under `tests/` and `tests/host/`, currently 6238 tests in total; the authoritative count is the command output. UI smoke tests run separately:
