...
**Test matrix**: `pnpm test` discovers all 178 `*.test.cjs` files under `tests/` and `tests/host/`, currently 5959 tests in total; the authoritative count is the command output. UI smoke tests run separately:
