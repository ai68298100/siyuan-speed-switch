...
**Test matrix**: `pnpm test` discovers all 170 `*.test.cjs` files under `tests/` and `tests/host/`, currently 5845 tests in total; the authoritative count is the command output. UI smoke tests run separately:
