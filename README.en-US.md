...
**Test matrix**: `pnpm test` discovers all 224 `*.test.cjs` files under `tests/` and `tests/host/`, currently 6044 tests in total; the authoritative count is the command output. UI smoke tests run separately:
