...
- MRU, favorites, pins, settings, and quick actions are validated and deduplicated on read; favorites are capped at 512 entries, pins at 64, and favorite groups at 64. Runtime reads defensively sanitize corrupted values, writes are debounced, and pending saves are flushed before unload.
