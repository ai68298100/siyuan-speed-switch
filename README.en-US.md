...
**Test matrix**: `pnpm test` discovers all 209 `*.test.cjs` files under `tests/` and `tests/host/`, currently 6287 tests in total; the authoritative count is the command output. UI smoke tests run separately:
