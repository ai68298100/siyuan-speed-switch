...
**Test matrix**: `pnpm test` discovers all 169 `*.test.cjs` files under `tests/` and `tests/host/`, currently 5796 tests in total; the authoritative count is the command output. UI smoke tests run separately:
