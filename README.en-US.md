...
**Test matrix**: `pnpm test` discovers all 211 `*.test.cjs` files under `tests/` and `tests/host/`, currently 6299 tests in total; the authoritative count is the command output. UI smoke tests run separately:
