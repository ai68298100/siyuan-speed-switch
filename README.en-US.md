...
**Test matrix**: `pnpm test` discovers all 201 `*.test.cjs` files under `tests/` and `tests/host/`, currently 6209 tests in total; the authoritative count is the command output. UI smoke tests run separately:
