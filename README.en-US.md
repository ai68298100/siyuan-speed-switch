...
**Test matrix**: `pnpm test` discovers all 89 `*.test.cjs` files under `tests/` and `tests/host/`, currently 672 tests in total. UI smoke tests run separately:
