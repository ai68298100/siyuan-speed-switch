...
**Test matrix**: `pnpm test` discovers all 225 `*.test.cjs` files under `tests/` and `tests/host/`, currently 6063 tests in total; the authoritative count is the command output. UI smoke tests run separately:
