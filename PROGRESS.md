...
验证基线：T-066~T-070 后 `pnpm verify:release` 全绿，包含 TypeScript、生产构建、555/555、移动烟测和 Chromium 样式烟测；raw bundle 自律预算 340 KiB，压缩包继续低于 300 KiB 硬上限。

待处理：

1. T-071：评估月历农历辅助信息的依赖、包体和可关闭交互。
