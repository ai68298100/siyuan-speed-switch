# 进度
补充（2026-09-14 发布修复）：`v0.16.41` 两次 GitHub Actions 均仅因 runner 性能抖动失败，已定位为基准 p95 阈值而非功能回归；按 D-276 校准至关键词/空查询 30/45ms（平均值 15/40ms、打开文档 2.5ms 不变），准备最终重跑 CI/Release。
