...
const CITY_ZONE_GROUPS = Object.freeze({
    ...
    "Asia/Bangkok": ["曼谷", "Bangkok", "清迈", "Chiang Mai", "普吉", "Phuket"],
    "Asia/Kuala_Lumpur": ["吉隆坡", "槟城", "Penang"],
    ...
    "Asia/Dubai": ["迪拜", "Dubai", "阿布扎比", "Abu Dhabi", "沙迦", "Sharjah"],
    ...
    "Asia/Ho_Chi_Minh": ["Hanoi", "河内", "胡志明市", "芽庄", "Nha Trang"],
    ...
    "Indian/Maldives": ["马累", "Male"],
    "Europe/Volgograd": ["伏尔加格勒", "Volgograd"],
    "Atlantic/Azores": ["亚速尔群岛", "Azores"],
    "Pacific/Kiritimati": ["基里蒂马蒂", "Kiritimati"],
