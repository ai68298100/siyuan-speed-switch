...
const CITY_ZONE_GROUPS = Object.freeze({
    "Asia/Shanghai": ["北京", "上海", "深圳", "广州", "成都", "杭州", "武汉", "西安", "重庆", "南京", "青岛", "大连", "厦门", "福州", "合肥", "郑州", "长沙", "哈尔滨", "沈阳", "昆明", "海口", "南昌", "东莞", "佛山", "无锡", "宁波", "拉萨", "西宁", "兰州", "南宁", "天津", "济南", "太原", "石家庄", "长春", "珠海", "中山", "嘉兴", "绍兴", "洛阳", "徐州", "温州", "台州", "贵阳", "呼和浩特", "银川", "南通", "扬州", "常州", "泉州", "Beijing", "Shanghai", "Shenzhen", "Guangzhou", "Chengdu", "Hangzhou", "Wuhan", "Xi'an", "Chongqing", "Nanjing", "Qingdao", "Dalian", "Xiamen", "Fuzhou", "Hefei", "Zhengzhou", "Changsha", "Harbin", "Shenyang", "Kunming", "Lhasa", "Tianjin", "Jinan", "Hohhot", "Yinchuan"],
    "Asia/Urumqi": ["乌鲁木齐", "Urumqi"],
    "Asia/Hong_Kong": ["香港", "Hong Kong"],
    "Asia/Macau": ["澳门", "Macau"],
    "Asia/Taipei": ["台北", "Taipei"],
    "Asia/Tokyo": ["东京", "大阪", "Tokyo", "Osaka", "Nagoya", "Fukuoka", "Sapporo", "名古屋", "福冈", "札幌"],
    "Asia/Seoul": ["首尔", "Seoul", "Busan", "釜山"],
    "Asia/Singapore": ["新加坡", "Singapore"],
    "Asia/Bangkok": ["曼谷", "Bangkok"],
    "Asia/Kuala_Lumpur": ["吉隆坡"],
    "Asia/Jakarta": ["雅加达", "Jakarta"],
    "Asia/Kolkata": ["新德里", "孟买", "Delhi", "Mumbai"],
    "Asia/Dubai": ["迪拜", "Dubai"],
    "Asia/Riyadh": ["利雅得"],
    "Europe/London": ["伦敦", "London", "Manchester", "曼彻斯特", "Edinburgh", "爱丁堡"],
    "Europe/Paris": ["巴黎", "Paris"],
    "Europe/Berlin": ["柏林", "Berlin", "Munich", "Hamburg", "慕尼黑", "汉堡"],
    "Europe/Rome": ["罗马", "Rome", "Milan", "Florence", "米兰", "佛罗伦萨"],
    "Europe/Madrid": ["马德里", "Madrid", "Barcelona", "巴塞罗那"],
    "Europe/Amsterdam": ["阿姆斯特丹", "Amsterdam"],
    "Europe/Zurich": ["苏黎世", "Zurich", "Geneva", "日内瓦"],
    "Europe/Stockholm": ["斯德哥尔摩", "Stockholm"],
    "Europe/Moscow": ["莫斯科", "Moscow"],
    "Europe/Istanbul": ["伊斯坦布尔", "Istanbul", "Ankara", "安卡拉"],
    "America/New_York": ["纽约", "New York", "Boston", "Miami", "Atlanta", "波士顿", "迈阿密", "亚特兰大"],
    "America/Los_Angeles": ["洛杉矶", "旧金山", "Los Angeles", "San Francisco", "Seattle", "西雅图", "San Diego", "圣迭戈"],
    "America/Chicago": ["芝加哥", "Chicago", "Houston", "休斯敦", "Dallas", "达拉斯"],
    "America/Denver": ["丹佛", "Denver"],
    "America/Toronto": ["多伦多", "Toronto", "Montreal", "蒙特利尔", "Ottawa", "渥太华"],
    "America/Vancouver": ["温哥华", "Vancouver"],
    "America/Sao_Paulo": ["圣保罗", "Sao Paulo"],
    "America/Argentina/Buenos_Aires": ["布宜诺斯艾利斯"],
    "Australia/Sydney": ["悉尼", "Sydney", "Canberra", "堪培拉"],
    "Australia/Melbourne": ["墨尔本", "Melbourne"],
    "Pacific/Auckland": ["奥克兰", "Auckland", "惠灵顿", "Wellington"],
    "Asia/Manila": ["Manila", "马尼拉"],
    "Asia/Ho_Chi_Minh": ["Hanoi", "河内"],
    ...
    "Asia/Karachi": ["Islamabad", "伊斯兰堡", "Karachi", "卡拉奇"],
    "Europe/Kyiv": ["Kyiv", "基辅"],
