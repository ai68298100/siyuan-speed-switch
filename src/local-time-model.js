...
const CITY_ZONE_GROUPS = Object.freeze({
    ...
    "Asia/Dubai": ["迪拜", "Dubai"],
    "Asia/Riyadh": ["利雅得", "吉达", "Jeddah"],
    "Europe/London": ["伦敦", "London", "Manchester", "曼彻斯特", "Edinburgh", "爱丁堡"],
    "Europe/Paris": ["巴黎", "Paris", "里昂", "Lyon", "马赛", "Marseille"],
    "Europe/Berlin": ["柏林", "Berlin", "Munich", "Hamburg", "慕尼黑", "汉堡", "法兰克福", "Frankfurt", "科隆", "Cologne", "斯图加特", "Stuttgart"],
    ...
    "America/New_York": ["纽约", "New York", "Boston", "Miami", "Atlanta", "波士顿", "迈阿密", "亚特兰大", "费城", "Philadelphia", "奥兰多", "Orlando"],
    "America/Los_Angeles": ["洛杉矶", "旧金山", "Los Angeles", "San Francisco", "Seattle", "西雅图", "San Diego", "圣迭戈", "拉斯维加斯", "Las Vegas", "波特兰", "Portland"],
    "America/Chicago": ["芝加哥", "Chicago", "Houston", "休斯敦", "Dallas", "达拉斯", "明尼阿波利斯", "Minneapolis"],
