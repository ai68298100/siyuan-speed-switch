...
const EXTERNAL_WIDGET_CATALOG = Object.freeze([
    ...
    catalogEntry({
        moduleId: "external-air-quality",
        title: "空气质量",
        category: "weather",
        availability: "external",
        auth: "none",
        integration: "http",
        providerName: "Open-Meteo Air Quality",
        sourceUrl: "https://open-meteo.com/en/docs/air-quality-api",
        license: "AGPL-3.0",
        privacy: "location-only",
        platforms: ["desktop", "sidebar", "mobile"],
        sizes: ["small", "medium", "wide"],
        description: "按用户选择的城市读取欧洲 AQI 与 PM2.5/PM10 浓度；不上传笔记内容，无需 API Key",
    }),
    catalogEntry({
    ...
    catalogEntry({
        moduleId: "external-news-hackernews",
        title: "Hacker News 热门",
        category: "trending",
        availability: "external",
        auth: "none",
        integration: "http",
        providerName: "Hacker News（Algolia 搜索 API）",
        sourceUrl: "https://hn.algolia.com/api/v1",
    ...
    catalogEntry({
        moduleId: "external-rss-miniflux",
        title: "未读文章",
        category: "trending",
        availability: "external",
        auth: "api-key",
        integration: "http",
        providerName: "Miniflux（自建 RSS 阅读器）",
        sourceUrl: "https://miniflux.app",
        license: "AGPL-3.0",
        privacy: "endpoint-only",
        platforms: ["desktop", "sidebar", "mobile"],
        sizes: ["medium", "wide", "large", "full"],
    ...
    catalogEntry({
        moduleId: "external-ical-events",
        title: "iCal 日程",
        category: "time",
        availability: "external",
        auth: "user-endpoint",
        integration: "http",
        providerName: "iCal 订阅（用户提供 .ics 地址）",
        sourceUrl: "https://datatracker.ietf.org/doc/html/rfc5545",
        license: "用户自选订阅源",
        privacy: "endpoint-only",
        platforms: ["desktop", "sidebar", "mobile"],
        sizes: ["medium", "wide", "large", "full"],
        description: "读取用户提供的 iCal（.ics）订阅地址，渲染未来窗口内的日程；无需 API Key",
    }),
    catalogEntry({
        moduleId: "external-rss-subscription",
        title: "RSS 订阅",
        category: "trending",
        availability: "external",
        auth: "user-endpoint",
        integration: "http",
        providerName: "RSS / Atom 订阅（用户提供 feed 地址）",
    ...
    catalogEntry({
        moduleId: "external-github-contrib",
        title: "GitHub 贡献",
        category: "activity",
        availability: "external",
        auth: "none",
        integration: "http",
        providerName: "GitHub（官方公开事件流）",
        sourceUrl: "https://docs.github.com/rest/activity/events",
        license: "GitHub 服务条款",
        privacy: "endpoint-only",
        platforms: ["desktop", "sidebar", "mobile"],
        sizes: ["medium", "wide", "large", "full"],
        description: "读取 GitHub 官方公开事件流并按周汇总贡献次数；可选 Token 经请求头传递且不进入 URL、缓存或错误消息",
    }),
    catalogEntry({
