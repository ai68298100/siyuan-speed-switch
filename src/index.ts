...
import {loadHolidayYear, allowedLifeWidgetUrl, allowedActivityWatchUrl, clearLifeWidgetCaches} from "./life-widget-network";
...
const version = beginSearch(session);
    ...
    // 设置页“文档集”分节的 UI 构建已外迁至 settings-sections.ts（R4 重构 D-376），经 .call(this) 绑定宿主调用。
