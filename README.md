...
[![Version](https://img.shields.io/badge/version-0.23.0-blue)](./plugin.json) [![License: MIT](https://img.shields.io/badge/license-MIT-green)](./LICENSE) [![SiYuan](https://img.shields.io/badge/SiYuan-%E6%80%9D%E6%BA%90%E7%AC%94%E8%AE%B0-ff5c67)](https://b3log.org/siyuan)
...
> v0.23.0 完成了全部 58 个组件的逐组件深度优化：搜索与页签筛选语义统一、iCal 订阅完整支持时区与重复日程、倒数日倒数/累计双模式、年度进度年/季/月周期、写作强度分与 12 个月回看、时间/倒数/引言三档数字大小、世界时钟跨日标记、设置页新增存储用量分节，切换器支持 Shift+F10 键盘呼出动作菜单。
