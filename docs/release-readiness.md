...
<!-- Current artifact snapshot: dist/index.js 803239 bytes; dist/index.css 150880 bytes; package.zip 379603 bytes; icon.png 160x160 18376 bytes; mobile self-regulation line 832 KiB (ADR 0062); archive ceiling 512 KiB. -->

Current build: `dist/index.js` 803239 bytes; `dist/index.css` 150880 bytes; `package.zip` 379603 bytes (v0.23.4 Release 资产实测；本地构建 379996，条目 CRC 一致)；`icon.png` 160x160 18376 bytes.
