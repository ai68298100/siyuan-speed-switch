...
<!-- Current artifact snapshot: dist/index.js 609173 bytes; dist/index.css 145109 bytes; package.zip 311363 bytes; icon.png 160x160 18376 bytes; mobile self-regulation line 768 KiB; archive ceiling 512 KiB. -->

Current build: `dist/index.js` 609173 bytes; `dist/index.css` 145109 bytes; `package.zip` 311363 bytes; `icon.png` 160x160 18376 bytes.
...
| 生产产物与包体 | 已通过 | 当前构建 `dist/index.js` 609173 bytes（768 KiB 自律线内，余量 177259 bytes）；`dist/index.css` 145109 bytes；`package.zip` 311363 bytes（512 KiB 硬上限余量 212925 bytes） |
