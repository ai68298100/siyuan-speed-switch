...
<!-- Current artifact snapshot: dist/index.js 559255 bytes; dist/index.css 142699 bytes; package.zip 319936 bytes; mobile self-regulation line 547 KiB. -->

Current build: `dist/index.js` 559255 bytes; `dist/index.css` 142699 bytes; `package.zip` 319936 bytes.
...
| 生产产物与包体 | 已通过 | 当前构建 `dist/index.js` 559255 bytes（547 KiB 自律线内）；`dist/index.css` 142699 bytes；`package.zip` 319936 bytes（320 KiB 硬上限余量 7744 bytes） |
