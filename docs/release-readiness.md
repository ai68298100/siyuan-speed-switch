...
| 版本元数据 | 已通过 | `0.32.0` 已同步 `package.json`、`plugin.json`、中英文 README 与双语 changelog；tag `v0.32.0`、推送和 Release workflow 已完成；含 R2-A 吸收批、过滤条、图标目录、卡片语言统一和 Essentials |
