...
| 版本元数据 | 已通过 | `0.34.0` 已同步 `package.json`、`plugin.json`、中英文 README 与双语 changelog；tag `v0.34.0`、推送和 Release workflow 已完成；含 R5-A 吸收批、工作上下文批、动作生态批、表面迁移主体与真实例 E2E 验收通道 |
