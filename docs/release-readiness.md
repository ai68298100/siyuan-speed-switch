...
<!-- Current artifact snapshot: dist/index.js 556787 bytes; dist/index.css 142699 bytes; package.zip 318028 bytes; mobile self-regulation line 544 KiB. -->

Current build: `dist/index.js` 556787 bytes; `dist/index.css` 142699 bytes; `package.zip` 318028 bytes.
...
| 生产产物与包体 | 已通过 | 当前构建 `dist/index.js` 556787 bytes（544 KiB 自律线内）；`dist/index.css` 142699 bytes；`package.zip` 318028 bytes（320 KiB 硬上限余量 9652 bytes） |
