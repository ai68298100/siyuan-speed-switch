...
<!-- Current artifact snapshot: dist/index.js 684954 bytes; dist/index.css 147573 bytes; package.zip 339861 bytes; icon.png 160x160 18376 bytes; mobile self-regulation line 768 KiB; archive ceiling 512 KiB. -->

Current build: `dist/index.js` 684954 bytes; `dist/index.css` 147573 bytes; `package.zip` 339861 bytes; `icon.png` 160x160 18376 bytes.
...
| 生产产物与包体 | 已通过 | 当前构建 `dist/index.js` 684954 bytes（768 KiB 自律线内，余量 101478 bytes）；`dist/index.css` 147573 bytes；`package.zip` 339861 bytes（512 KiB 硬上限余量 184427 bytes）；zip 单条目压缩预算 168→180 KiB（T-6298 / ADR 0057，负向验证回退到 168 KiB 仍精确 FAIL）；T-6307~T-6330 增量在此预算内，未再上调 |
