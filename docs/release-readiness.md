...
<!-- Current artifact snapshot: dist/index.js 560365 bytes; dist/index.css 142699 bytes; package.zip 320582 bytes; mobile self-regulation line 548 KiB. -->

Current build: `dist/index.js` 560365 bytes; `dist/index.css` 142699 bytes; `package.zip` 320582 bytes.
...
| 生产产物与包体 | 已通过 | 当前构建 `dist/index.js` 560365 bytes（548 KiB 自律线内，余量 787 bytes）；`dist/index.css` 142699 bytes；`package.zip` 320582 bytes（320 KiB 硬上限余量 7098 bytes） |
