...
<!-- Current artifact snapshot: dist/index.js 558998 bytes; dist/index.css 142699 bytes; package.zip 319661 bytes; mobile self-regulation line 546 KiB. -->

Current build: `dist/index.js` 558998 bytes; `dist/index.css` 142699 bytes; `package.zip` 319661 bytes.
...
| 生产产物与包体 | 已通过 | 当前构建 `dist/index.js` 558998 bytes（546 KiB 自律线内）；`dist/index.css` 142699 bytes；`package.zip` 319661 bytes（320 KiB 硬上限余量 8019 bytes） |
