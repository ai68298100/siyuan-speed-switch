...
<!-- Current artifact snapshot: dist/index.js 653949 bytes; dist/index.css 147573 bytes; package.zip 328118 bytes; icon.png 160x160 18376 bytes; mobile self-regulation line 768 KiB; archive ceiling 512 KiB. -->

Current build: `dist/index.js` 653949 bytes; `dist/index.css` 147573 bytes; `package.zip` 328118 bytes; `icon.png` 160x160 18376 bytes.
...
| 生产产物与包体 | 已通过 | 当前构建 `dist/index.js` 653949 bytes（768 KiB 自律线内，余量 132483 bytes）；`dist/index.css` 147573 bytes；`package.zip` 328118 bytes（512 KiB 硬上限余量 196170 bytes）；zip 单条目压缩预算 168→180 KiB（T-6298 / ADR 0057：`index.js` 压缩后 164015→175727 bytes，纯本地只读增量，按 D-353/D-366/D-386 先例上调，负向验证回退到 168 KiB 仍精确 FAIL） |
