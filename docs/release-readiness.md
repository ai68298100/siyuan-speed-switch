...
<!-- Current artifact snapshot: dist/index.js 555569 bytes; dist/index.css 142699 bytes; package.zip 317756 bytes; mobile self-regulation line 543 KiB. -->

Current build: `dist/index.js` 555569 bytes; `dist/index.css` 142699 bytes; `package.zip` 317756 bytes.
...
| 生产产物与包体 | 已通过 | 当前构建 `dist/index.js` 555569 bytes（543 KiB 自律线内）；`dist/index.css` 142699 bytes；`package.zip` 317756 bytes（320 KiB 硬上限余量 9924 bytes） |
