...
<!-- Current artifact snapshot: dist/index.js 610264 bytes; dist/index.css 145639 bytes; package.zip 312069 bytes; icon.png 160x160 18376 bytes; mobile self-regulation line 768 KiB; archive ceiling 512 KiB. -->

Current build: `dist/index.js` 610264 bytes; `dist/index.css` 145639 bytes; `package.zip` 312069 bytes; `icon.png` 160x160 18376 bytes.

评估日期：2026-09-15（v0.17.0 发布后开发头）；真实宿主补充验收仍按兼容性任务持续跟进。

| 检查项 | 状态 | 证据/剩余动作 |
| --- | --- | --- |
| TypeScript、自动测试、UI smoke | 已通过 | 完整测试 5740/5740（含本轮 11 项手机端图标兜底与布局契约）；TypeScript、移动端 smoke 70 项、Chromium smoke、手机布局门禁与生产图隔离测试通过 |
| 生产产物与包体 | 已通过 | 当前构建 `dist/index.js` 610264 bytes（768 KiB 自律线内，余量 176168 bytes）；`dist/index.css` 145639 bytes；`package.zip` 312069 bytes（512 KiB 硬上限余量 212219 bytes） |
