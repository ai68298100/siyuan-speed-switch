...
<!-- Current artifact snapshot: dist/index.js 560411 bytes; dist/index.css 142699 bytes; package.zip 320588 bytes; mobile self-regulation line 548 KiB. -->

Current build: `dist/index.js` 560411 bytes; `dist/index.css` 142699 bytes; `package.zip` 320588 bytes.
...
| 生产产物与包体 | 已通过 | 当前构建 `dist/index.js` 560411 bytes（548 KiB 自律线内，余量 741 bytes）；`dist/index.css` 142699 bytes；`package.zip` 320588 bytes（320 KiB 硬上限余量 7092 bytes） |
